...
export const DEFAULT_MONTHLY_SUBSCRIPTION_USD_PER_SUBSCRIBER = 2.0;

export const ENGAGEMENT_BONUS_FACTOR = 0.5;

export function engagementRevenueMultiplier(engagementRate: number): number {
  return 1 + engagementRate * ENGAGEMENT_BONUS_FACTOR;
}
